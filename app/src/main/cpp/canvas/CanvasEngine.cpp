...
Java_com_example_zhanfang_test_Canvas_init(JNIEnv* env, jclass obj, jobject jSurface, jint width, jint height) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_zhanfang_test_Canvas_initGl(JNIEnv* env, jclass obj, jobject jSurface, jint width, jint height) {
